...
public enum AuxiliaryCommandEnum {
    ...
    FLY_SPEED_PERMISSION(CommandEnum.PLUGHIN_NAME.getCommand() + "." + FLY_SPEED_COMMAND.getCommand(), "需改飞行速度的权限"),
    FLY_SPEED_OTHERS_PERMISSION(FLY_SPEED_PERMISSION.getCommand() + "." + CommandEnum.OTHERS.getCommand(), "需改他人飞行速度的权限"),

    /**
     * 移动速度
     */
    WALK_SPEED_COMMAND("walkspeed", "移动速度的指令"),
    WALK_SPEED_PERMISSION(CommandEnum.PLUGHIN_NAME.getCommand() + "." + WALK_SPEED_COMMAND.getCommand(), "修改移动速度的权限"),
    WALK_SPEED_OTHERS_PERMISSION(WALK_SPEED_PERMISSION.getCommand() + "." + CommandEnum.OTHERS.getCommand(), "修改他人移动速度的权限");
